package com.next.sheharyar.sunshinenewapp.utilities;
...
public class NetworkUtils {
    ...
    /*The Units we want our API return*/
    private static final String units = "metric";
    /*The Number of days we want our API return*/
    private static final int mDays = 14;

    final static String QUERY_PARAM = "q";
    final static String LAT_PARAM = "lat";
    final static String LON_OARAM = "lon";
